"""
Django settings for whatsApp_saas project.
...
SECRET_KEY = 'django-insecure-nk$ufq1p0rh^h8*k)^^#@@x1x=$+5$d00+fm9)^1l+l!offzw$'
...
AUTHENTICATION_BACKENDS = [
    'user_authentication.authenticate.EmailOrPhoneNumberBackend',
